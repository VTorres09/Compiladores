...
public class Regex {
	...
	private static final String ID_REGEX = "^([a-zA-Z_][a-zA-Z\\d_]*)$"; // recognizes a id which only have letters (uppercased or not) and starts with a letter or an underscore
